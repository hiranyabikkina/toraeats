...
@RestController
@RequestMapping("/api/tora-eats-kafka")
public class ToraEatsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ToraEatsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ToraEatsKafkaResource(KafkaProperties kafkaProperties) {
